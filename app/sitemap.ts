...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${SITE_URL}/where-to-share-your-product`, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE_URL}/product-hunt-alternatives`, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE_URL}/how-to-get-product-feedback`, changeFrequency: 'monthly', priority: 0.6 },
